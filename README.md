...
No classes, no `this`, no `var`, no arrow functions, no function declarations; one self-invoking module per file, four-space indent, double quotes. The loader's test kit enforces it — see [`docs/style.md`](https://github.com/dreasgrech/ACEUIModLoader/blob/main/docs/style.md) there.
